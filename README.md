...
[![version](https://img.shields.io/badge/version-1.53.0-black)](https://github.com/avanturer/claude-bestpractice/releases)
...
```
make check    # lint · docs gate · slop gate · polyglot gate · knowledge · 1316 tests · 33 doctor checks · budget
```
