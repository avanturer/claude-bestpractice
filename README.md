...
[![version](https://img.shields.io/badge/version-1.0.6-black)](https://github.com/avanturer/claude-bestpractice/releases)
[![tests](https://img.shields.io/badge/tests-710%20passing-2ea44f)](#verified)
...
```
make check    # lint · docs gate · slop gate · polyglot gate · knowledge · 710 tests · 26 doctor checks · budget
```
