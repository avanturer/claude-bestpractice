...
[![version](https://img.shields.io/badge/version-1.0.5-black)](https://github.com/avanturer/claude-bestpractice/releases)
[![tests](https://img.shields.io/badge/tests-700%20passing-2ea44f)](#verified)
...
```
make check    # lint · docs gate · slop gate · polyglot gate · knowledge · 700 tests · 26 doctor checks · budget
```
