...
[![version](https://img.shields.io/badge/version-1.0.9-black)](https://github.com/avanturer/claude-bestpractice/releases)
[![tests](https://img.shields.io/badge/tests-727%20passing-2ea44f)](#verified)
...
```
make check    # lint · docs gate · slop gate · polyglot gate · knowledge · 727 tests · 26 doctor checks · budget
```
