...
[![version](https://img.shields.io/badge/version-1.40.0-black)](https://github.com/avanturer/claude-bestpractice/releases)
[![tests](https://img.shields.io/badge/tests-1295%20passing-2ea44f)](#verified)
...
```
make check    # lint · docs gate · slop gate · polyglot gate · knowledge · 1295 tests · 33 doctor checks · budget
```
