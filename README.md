...
[![tests](https://img.shields.io/badge/tests-1314%20passing-2ea44f)](#verified)
...
```
make check    # lint · docs gate · slop gate · polyglot gate · knowledge · 1314 tests · 33 doctor checks · budget
```
