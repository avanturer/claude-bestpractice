...
[![version](https://img.shields.io/badge/version-1.32.0-black)](https://github.com/avanturer/claude-bestpractice/releases)
[![tests](https://img.shields.io/badge/tests-1258%20passing-2ea44f)](#verified)
...
```
make check    # lint · docs gate · slop gate · polyglot gate · knowledge · 1258 tests · 33 doctor checks · budget
```
