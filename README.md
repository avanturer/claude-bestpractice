...
[![tests](https://img.shields.io/badge/tests-1277%20passing-2ea44f)](#verified)
...
```
make check    # lint · docs gate · slop gate · polyglot gate · knowledge · 1277 tests · 33 doctor checks · budget
```
