...
[![tests](https://img.shields.io/badge/tests-606%20passing-2ea44f)](#verified)
...
```
make check    # lint · docs gate · slop gate · polyglot gate · knowledge · 606 tests · 25 doctor checks · budget
```
