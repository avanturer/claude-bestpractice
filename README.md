...
[![tests](https://img.shields.io/badge/tests-697%20passing-2ea44f)](#verified)
...
```
make check    # lint · docs gate · slop gate · polyglot gate · knowledge · 697 tests · 26 doctor checks · budget
```
