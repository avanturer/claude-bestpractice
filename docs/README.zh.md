...
[![tests](https://img.shields.io/badge/tests-1258%20passing-2ea44f)](#已验证)
...
```
make check    # lint · docs gate · slop gate · polyglot gate · knowledge · 1258 个测试 · 33 项 doctor 检查 · budget
```
