...
[![tests](https://img.shields.io/badge/tests-506%20passing-2ea44f)](#已验证)
...
```
make check    # lint · docs gate · slop gate · polyglot gate · knowledge · 506 个测试 · 25 项 doctor 检查 · budget
```
