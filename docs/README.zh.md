...
[![tests](https://img.shields.io/badge/tests-685%20passing-2ea44f)](#已验证)
...
```
make check    # lint · docs gate · slop gate · polyglot gate · knowledge · 685 个测试 · 26 项 doctor 检查 · budget
```
