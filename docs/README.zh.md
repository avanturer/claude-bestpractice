...
[![version](https://img.shields.io/badge/version-1.0.16-black)](https://github.com/avanturer/claude-bestpractice/releases)
...
```
make check    # lint · docs gate · slop gate · polyglot gate · knowledge · 738 个测试 · 26 项 doctor 检查 · budget
```
